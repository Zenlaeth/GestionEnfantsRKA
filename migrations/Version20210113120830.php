 ...
 */
final class Version20210113120830 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE password_update (id INT AUTO_INCREMENT NOT NULL, old_password VARCHAR(255) NOT NULL, new_password VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
